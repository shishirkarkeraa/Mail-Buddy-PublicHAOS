...
Mail-Buddy is a private, single-user Gmail organizer for macOS and Raspberry
Pi 5. It classifies English email with `llama3.2:3b-instruct-q4_K_M` running in
local Ollama, stages historical decisions for review, and applies Gmail labels
only when the relevant category is approved.
